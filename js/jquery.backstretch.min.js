/*! Backstretch - v2.1.18 - 2019-09-18\n* Copyright (c) 2019 Scott Robbin;* Fork of improvements - by Daniel Cohen Gindi (danielgindi@gmail.com) Licensed MIT */ !(function (
    ...
    g = (function () {
      var c = function (a) {
          for (var b = 1; b < a.length; b++) {
            for (
              var c = a[b], d = b;
              a[d - 1] && parseInt(a[d - 1].width, 10) > parseInt(c.width, 10);
        ...
        d = function (a, c, d) {
          for (
            var e,
              ...
              h = q(),
              i = (r(), c > a ? 'portrait' : a > c ? 'landscape' : 'square'),
              j = 0,
              k = 0;
            k < d.length &&
            ((f = d[k]),
            ...
            (f.pixelRatio &&
              ...
              (f.deviceOrientation && f.deviceOrientation !== h) ||
              (f.windowOrientation && f.windowOrientation !== h) ||
  ...
  n.prototype = {
        ...
        return (
          l
            ? ((e.videoWrapper = new p(k)),
              (e.$item = e.videoWrapper.$video.css('pointer-events', 'none')))
            : (e.$item = a('<img />')),
          (e.$itemWrapper = a('<div class="backstretch-item">').append(
            e.$item
          )),
          this.options.bypassCss
            ? e.$itemWrapper.css({ display: 'none' })
            : (e.$itemWrapper.css(f.itemWrapper), e.$item.css(f.item)),
            ...
            var q = function (a) {
              ...
              u = function () {
                i && (i.stop(), i.destroy()),
                  ...
                  e.options.bypassCss ||
                    e.isBody ||
                    e.$container.css('background-image', 'none'),
                  a(['after', 'show']).each(function () {
                    e.$container.trigger(a.Event('backstretch.' + this, j), [
                      e,
                      b
                    ])
                  }),
    ...
    next: function () {
      ...
      return (
        a.unshift(this.index < this.images.length - 1 ? this.index + 1 : 0),
    ...
    prev: function () {
      var a = Array.prototype.slice.call(arguments, 0)
      return (
        a.unshift(0 === this.index ? this.images.length - 1 : this.index - 1),
        this.show.apply(this, a)
      )
    },
    pause: function () {
  ...
  ;(p.prototype.init = function (d) {
        ...
        events: {
          onReady: function () {
            c.__ytStartMuted && g.mute(),
              e ||
                (c.$video[0].parentNode === f[0] && c.$video.detach(),
                f.remove()),
              (c.ytReady = !0),
    ...
    (p.prototype.play = function () {
      ...
      return (
        ...
        'youtube' === a.type
          ? a.ytReady && (a.$video.trigger('play'), a.ytPlayer.playVideo())
          : a.video.play(),
        a
      )
    }),
    ...
    (p.prototype.stop = function () {
      ...
      return (
        ...
        'youtube' === a.type
          ? a.ytReady && (a.ytPlayer.pauseVideo(), a.ytPlayer.seekTo(0))
  ...
  var q = function () {
    ...
    s = (function () {
      ...
      return !(
        ...
        (a.indexOf('MeeGo') > -1 && a.indexOf('NokiaBrowser/8.5.0') > -1) ||
        (k && k <= 6)
      )
    })()
})(jQuery, window)
